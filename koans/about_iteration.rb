...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Answer: `inject` (also known as `reduce`) applies a binary operation (specified by a block) to the elements of an enumerable collection, accumulating a result. It takes an initial value and applies the operation to the initial value and the first element of the collection, then takes the result of that operation and the second element, and so on, until all elements have been processed. The final result is returned.
  end
